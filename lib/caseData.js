...
/**
 * 판단을 끝냈다고 생각한 순간 새 정보가 도착한다.
 * 핵심 메시지: 새 정보는 '사실'을 바꾸지 않지만 '추측'은 흔든다.
 */
export const TWIST_INTRO = {
  eyebrow: "3일 전 · 그룹 프로젝트 회의",
  title: "새로운 메시지가 도착했습니다!",
  sub: "지금까지의 생각이 바뀔 수도 있어요.",
};

export const TWIST_MESSAGES = [
  {
    id: "seohyun",
    from: "서현",
    role: "같은 조 · 2학년 3반",
...
/**
 * 새 메시지를 읽고 기존 판단을 다시 본다.
 * stand  — 새 정보가 들어와도 그대로 남는 관찰된 사실
 * shaken — 새 정보로 근거가 흔들리는 추측
 */
